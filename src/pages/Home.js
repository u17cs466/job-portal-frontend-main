        ...
        <div className="container flex space-x-6 mx-20 mt-20">
            ...
            <div className="w-2/6 h-auto bg-white rounded flex-col">
                <div className="h-40 mr-10 ">
                    ...
                    <img className="w-full h-full rounded-sm" src={logo} alt="Display" />
                ...
                <div className="bg-white-600 flex justify-between h-28">
                    ...
                    <div class="space-y-4">
                        <div className="h-8 w-8 flex items-center justify-center ml-10 -my-3.5">
                            <img className="w-full h-full rounded-full" src={image} alt="Display" />
                        </div>
                ...
                <div className="ml-5 flex-col space-y-8 mt-4">
                    ...
                    <p className="text-left">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Cursus semper in arcu facilisi elementum laoreet. Nisi pellentesque luctus turpis morbi mauris donec. Amet leo sed ipsum, mi. Velit tellus, mattis diam ipsum in sed mi. </p>
                    <p className="text-left">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Cursus semper in arcu facilisi elementum laoreet. Nisi pellentesque luctus turpis morbi mauris donec. </p>
                    <div className="h-">
                        <button className="bg-red-400 hover:bg-red-400 text-white font-bold py-2 px-4 rounded ml-44 mt-20">Apply</button>
                    </div>
                </div>
            </div>
        </div>
